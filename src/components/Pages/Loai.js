...
const Loai = () => {
    ...
    //data
    const columns = [
        { field: 'MaLoai', headerName: 'Mã loại', flex: 1 },
        { field: 'TenLoai', headerName: 'Tên', flex: 1 },
                                            ...
                                            <div className="show-watch-form-container">
                                                ...
                                                <form>
                                                    {isEditing ? (
                                                        ...
                                                        <>
                                                            <p className="text">Tên: {selectedWatch.TenLoai}</p>

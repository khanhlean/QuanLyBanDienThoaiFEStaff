...
const Voucher = () => {
    ...
    async function fetchData() {
        try {
            ...
            //console.log(token);
            const response = await API.get('/khuyenmai/get-all-voucher', {
                // headers: {
    ...
    //data
    const columns = [
        { field: 'MaVC', headerName: 'Mã VOUCHER', flex: 1 },
        { field: 'Code', headerName: 'Code', flex: 1 },
        { field: 'PhanTramGiam', headerName: 'Phần trăm giảm', flex: 1 },
    ];
                    ...
                    <div className="watchlist_content">
                        <div className="pl_header">
                            <div className="pl_header__title">
                                <h1 className="title-72">VOUCHER</h1>
                            </div>
                        </div>
                                            ...
                                            <div className="show-watch-form-container">
                                                ...
                                                <form>
                                                    {isEditing ? (
                                                        ...
                                                        <>
                                                            <p className="text">Code: {selectedWatch.Code}</p>
                                                            <p className="text">
                                                                Phần trăm giảm: {selectedWatch.PhanTramGiam}
                                                            </p>
                                                        </>
                                                    )}
